...
import { at as ArrowDownUp, b as Percent, r as Wallet } from "../_libs/lucide-react.mjs";
import { i as useTransactions, n as useInvoices, t as useCommissions } from "./use-finance-BUeqwFsG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/finance-WYQjHDRm.js
...
function FinanceComponent() {
	...
	const totalCommissions = commissions.filter((c) => c.status === "paid").reduce((acc, c) => acc + (Number(c.amount) || 0), 0);
