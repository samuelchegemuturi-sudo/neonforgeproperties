...
import { i as useAuth, r as useAppStore, t as AuthProvider } from "./auth-BCmnXUlU.mjs";
...
import { t as Route$35 } from "./auth-Ctz85z9e.mjs";
import { f as sendEmailFn } from "./platform.functions-BWY0p-Ku.mjs";
import { n as toast, t as Toaster } from "../_libs/sonner.mjs";
import { $ as Briefcase, B as CreditCard, D as Map, E as Megaphone, F as FileText, H as Circle, J as ChevronRight, K as CircleAlert, L as DoorOpen, M as LayoutDashboard, N as KeyRound, O as MapPin, P as House, Q as Building2, S as PanelLeft, X as Check, Z as ChartColumn, a as UserCog, b as Percent, ct as Activity, d as ShieldCheck, et as Bell, f as Settings, h as ScrollText, i as Users, j as LifeBuoy, k as LogOut, l as Tags, m as Search, n as Wrench, nt as BadgeCheck, o as Undo2, ot as ArrowLeftRight, p as Send, r as Wallet, t as X, y as Plug, z as DatabaseBackup } from "../_libs/lucide-react.mjs";
...
import { t as Route$36 } from "./leases_._leaseId.statement-6rZmWjGN.mjs";
import { t as Textarea } from "./textarea-kko37XEX.mjs";
import { i as ThemeButton, n as AvatarFallback, o as ThemeProvider, t as Avatar } from "./avatar-B0TtxMp4.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-HiEEcBdd.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-h2gW9vow.css";
var Toaster$1 = ({ ...props }) => {
...
function AppBackground() {
	...
	if (!mounted) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 z-[-2] bg-background" });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [backgroundImage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "fixed inset-0 z-[-2] bg-cover bg-center bg-no-repeat transition-opacity duration-1000",
		style: { backgroundImage: `url(${backgroundImage})` }
	}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 z-[-2] bg-background transition-colors duration-1000" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 z-[-1] bg-background/20 dark:bg-background/60" })] });
}
...
var $$splitComponentImporter$31 = () => import("./routes-nVWHBRjo.mjs");
...
var Sidebar = import_react.forwardRef(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
	...
	if (collapsible === "none") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn(`flex h-full w-(--sidebar-width) flex-col ${glassOpacity} ${blurIntensity} saturate-[1.8] text-sidebar-foreground border-r border-white/20 dark:border-white/10`, className),
		ref,
		...props,
		children
	});
...
function AppSidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		className: "print:hidden my-4 ml-4",
		variant: "floating",
		collapsible: "icon",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [access?.company?.logo_url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
				className: "w-[180px] h-8 text-xs bg-background/50 border-primary/20 hover:bg-background/80 transition-colors",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Impersonate Company..." })
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
				value: "none",
				className: "text-muted-foreground italic",
				children: "Stop Impersonating"
			}), companies?.map((company) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
				value: company.id,
...
var Route$32 = createFileRoute("/_authenticated")({
	ssr: false,
	beforeLoad: async () => {
...
function RouteComponent() {
	...
	if ((isPastDue || isSuspended) && !(access?.profile?.is_super_admin && isSuperAdminRoute) && ![
		...
		className: `flex min-h-screen w-full items-center justify-center p-4 ${glassOpacity} ${blurIntensity}`,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "max-w-md text-center space-y-4 rounded-3xl border border-border/40 bg-background/60 p-8 shadow-xl backdrop-blur-3xl saturate-200",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "sticky top-4 z-30 px-4 sm:px-6 mb-4 transition-all duration-300",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					className: `flex h-14 items-center gap-3 rounded-full border border-border/40 ${glassOpacity} px-4 shadow-[0_8px_30px_rgb(0,0,0,0.08)] ${blurIntensity} saturate-[1.8] print:hidden`,
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CompanyImpersonator, {}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										variant: "ghost",
										className: "gap-2 px-2 rounded-full hover:bg-muted/60",
									...
									align: "end",
									className: `w-56 rounded-xl border-border/40 ${glassOpacity} ${blurIntensity}`,
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuItem, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
												to: "/settings",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "size-4 mr-2" }), " Settings"]
											})
										}),
				...
				className: "px-4 sm:px-6 pb-6 flex-1 flex flex-col",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
					className: `flex-1 rounded-3xl border border-border/30 ${glassOpacity} ${blurIntensity} saturate-[1.8] shadow-2xl p-4 sm:p-6 overflow-hidden`,
...
var $$splitComponentImporter$30 = () => import("./forgot-password-Cciosry-.mjs");
var Route$31 = createFileRoute("/forgot-password")({ component: lazyRouteComponent($$splitComponentImporter$30, "component") });
var $$splitComponentImporter$29 = () => import("./activity-96-nMkCl.mjs");
var Route$30 = createFileRoute("/_authenticated/activity")({ component: lazyRouteComponent($$splitComponentImporter$29, "component") });
var $$splitComponentImporter$28 = () => import("./analytics-Cte-1One.mjs");
var Route$29 = createFileRoute("/_authenticated/analytics")({ component: lazyRouteComponent($$splitComponentImporter$28, "component") });
var $$splitComponentImporter$27 = () => import("./audit-B3t0zjIg.mjs");
var Route$28 = createFileRoute("/_authenticated/audit")({ component: lazyRouteComponent($$splitComponentImporter$27, "component") });
var $$splitComponentImporter$26 = () => import("./backup-BgJgZkeR.mjs");
var Route$27 = createFileRoute("/_authenticated/backup")({ component: lazyRouteComponent($$splitComponentImporter$26, "component") });
var $$splitComponentImporter$25 = () => import("./branches-B3O_1V0T.mjs");
var Route$26 = createFileRoute("/_authenticated/branches")({ component: lazyRouteComponent($$splitComponentImporter$25, "component") });
var $$splitComponentImporter$24 = () => import("./commissions-C0ZL3fFE.mjs");
var Route$25 = createFileRoute("/_authenticated/commissions")({ component: lazyRouteComponent($$splitComponentImporter$24, "component") });
var $$splitComponentImporter$23 = () => import("./companies-B3EIBHq_.mjs");
...
var $$splitComponentImporter$22 = () => import("./dashboard-BDglKdxS.mjs");
...
var $$splitComponentImporter$20 = () => import("./employees-B1dHcvKD.mjs");
...
var $$splitComponentImporter$19 = () => import("./finance-BKOODyH3.mjs");
var Route$20 = createFileRoute("/_authenticated/finance")({ component: lazyRouteComponent($$splitComponentImporter$19, "component") });
var $$splitComponentImporter$18 = () => import("./force-password-change-Dakonjsd.mjs");
...
var $$splitComponentImporter$17 = () => import("./integrations-CZHKBZnR.mjs");
...
var $$splitComponentImporter$16 = () => import("./leases-DYaMO5Ff.mjs");
...
var $$splitComponentImporter$15 = () => import("./licences-IBi5f1eI.mjs");
...
var $$splitComponentImporter$13 = () => import("./maintenance-ueEtveL4.mjs");
...
var $$splitComponentImporter$11 = () => import("./onboarding-lzw75mjr.mjs");
...
var $$splitComponentImporter$10 = () => import("./pricing-D9Xoy-aN.mjs");
...
var $$splitComponentImporter$9 = () => import("./properties-qYKatbRx.mjs");
...
var $$splitComponentImporter$5 = () => import("./settings-BUaAJocP.mjs");
...
var $$splitComponentImporter$4 = () => import("./subscriptions-C6mgx-2b.mjs");
...
var AuthenticatedRouteRoute = Route$32.update({
	id: "/_authenticated",
	getParentRoute: () => Route$34
});
...
var AuthenticatedRouteRouteChildren = {
	AuthenticatedActivityRoute: Route$30.update({
		id: "/activity",
		path: "/activity",
		getParentRoute: () => AuthenticatedRouteRoute
	}),
	AuthenticatedAnalyticsRoute: Route$29.update({
		id: "/analytics",
		path: "/analytics",
		getParentRoute: () => AuthenticatedRouteRoute
	}),
	AuthenticatedAuditRoute: Route$28.update({
		id: "/audit",
		path: "/audit",
		getParentRoute: () => AuthenticatedRouteRoute
	}),
	AuthenticatedBackupRoute: Route$27.update({
		id: "/backup",
		path: "/backup",
		getParentRoute: () => AuthenticatedRouteRoute
	}),
	AuthenticatedBranchesRoute: Route$26.update({
		id: "/branches",
		path: "/branches",
		getParentRoute: () => AuthenticatedRouteRoute
	}),
	...
	AuthenticatedLeasesLeaseIdStatementRoute: Route$36.update({
