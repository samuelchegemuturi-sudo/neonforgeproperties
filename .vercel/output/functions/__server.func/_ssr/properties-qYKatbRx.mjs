...
import { O as MapPin, Q as Building2, nt as BadgeCheck, v as Plus } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/properties-qYKatbRx.js
...
function PropertiesPage() {
	...
	const { data: clientLandlords } = useQuery({
		...
		queryFn: async () => {
			const { data, error } = await supabase.from("user_roles").select("user_id, profiles(id, full_name, email), roles!inner(slug)").eq("company_id", companyId).eq("roles.slug", "client_landlord");
	...
	const { data: properties, isLoading } = useQuery({
		...
		queryFn: async () => {
			let q = supabase.from("properties").select("id, name, property_type, address, city, latitude, longitude, status, verification_status, created_at, company_id, owner_id, units(count)");
			if (access?.roles?.some((r) => r.slug === "client_landlord") && access?.profile?.id) q = q.eq("owner_id", access.profile.id);
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									clientLandlords && clientLandlords.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "grid gap-1.5",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											htmlFor: "p-owner",
											children: "Property Owner (Client Landlord)"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
											name: "owner_id",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
												id: "p-owner",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Select an owner (optional)" })
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
												value: "none",
												children: "None (Agency owned)"
											}), clientLandlords.map((cl) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectItem, {
												value: cl.id,
												children: [
													cl.full_name,
													" (",
									...
									branches && branches.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "grid gap-1.5",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											htmlFor: "p-branch",
											children: "Branch / Region"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
											name: "branch_id",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
												id: "p-branch",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Select a branch (optional)" })
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
												value: "none",
												children: "Unassigned"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
									id: "ut-slug",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {})
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: (rules ?? []).map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
									value: r.slug,
									children: r.label
								}, r.slug)) })]
							})]
