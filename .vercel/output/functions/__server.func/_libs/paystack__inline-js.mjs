...
function s(e, t) {
	return function(e) {
		...
		if (null != n) {
			var a, r, i, o, c = [], s = !0, l = !1;
			try {
				if (i = (n = n.call(e)).next, 0 === t) {
					if (Object(n) !== n) return;
					s = !1;
				} else for (; !(s = (a = i.call(n)).done) && (c.push(a.value), c.length !== t); s = !0);
			} catch (e) {
				l = !0, r = e;
			} finally {
				try {
...
function g(e, t) {
	...
	return Object.keys(e).forEach(function(a) {
		var r = t ? "".concat(t, "[").concat(a, "]") : a, i = e[r];
		n.push(null !== i && "object" === ("undefined" == typeof v ? "undefined" : p(v)) ? g(i, r) : "".concat(encodeURIComponent(a), "=").concat(encodeURIComponent(i)));
	}), n.join("&");
}
function b() {
...
function k() {
	var e = [], t = b();
	if (t) {
		var n = Array.prototype.slice.call(t.attributes);
		e = Object.keys(n).filter(function(e) {
			var t = n[e].nodeName;
			return t && t.indexOf("data") > -1;
		}).map(function(e) {
			return n[e].nodeName;
		});
	}
...
var C = function(e) {
	return e && "object" === p(e) ? Object.keys(w).reduce(function(t, n) {
		return o(o({}, t), {}, r({}, n, e[n] || w[n]));
	}, {}) : w;
};
var P = function() {
...
function x(e) {
	return Object.keys(e).reduce(function(t, n) {
		var a = encodeURIComponent(n), r = encodeURIComponent(e[n]), i = "".concat(a, "=").concat(r);
		return [].concat(l(t), [i]);
	}, []).join("&");
}
var A = function(e) {
...
var q = function() {
	try {
		return window.location && "https:" === window.location.protocol && window.ApplePaySession && window.ApplePaySession.supportsVersion(f.applePayVersion);
	} catch (e) {
		return !1;
	}
};
var E = function() {
	...
	return q() && e.includes("apple_pay");
};
function T(e) {
	var t = document.createElement("iframe");
	return t.setAttribute("frameBorder", "0"), t.setAttribute("allowtransparency", "true"), t.id = e, t.style.display = "none", t;
}
function _(e) {
...
function O(e, t, n) {
	var a = t.channels, r = void 0 === a ? [] : a, i = t.styles, o = void 0 === i ? {} : i, c = { applePay: !1 };
	return new Promise(function(t, a) {
		if (e) if (E(r)) {
			if (_(e)) return c.applePay = !0, void t(c);
			(function(e, t) {
				var n = t.container, a = t.integrity;
				return new Promise(function(t, r) {
					e || r("No script url");
					var i = document.createElement("script");
					i.src = e, i.crossOrigin = "anonymous", a && (i.integrity = a), i.addEventListener("load", function() {
						t(!0);
					}), i.addEventListener("error", function() {
						i.remove(), r(!1);
					}), n ? n.appendChild(i) : document.head.appendChild(i);
				});
			})("https://applepay.cdn-apple.com/jsapi/v1.1.0/apple-pay-sdk.js", {
				container: e,
				integrity: "sha384-z/6BVHCcSypLSykOVpaT1PQWHOOgU45uOOlMkgi/bElX4yFqmChNMb7qiv80wFav"
			}).then(function() {
				if (n && 1077497 !== n && window && !Array.isArray(window.webpackJsonp)) throw new Error("Incorrect data type for 'webpackJsonp', expected array, got ".concat(p(window.webpackJsonp), ". Switching to fallback apple pay button"));
				(function(e, t) {
					var n, a, r, i, o, c = t.styles, s = t.theme, l = document.createElement("style"), u = (a = (n = c).height, r = n.width, i = n.borderRadius, o = n.padding, "\n  apple-pay-button {\n    --apple-pay-button-width: ".concat(r, ";\n    --apple-pay-button-height: ").concat(a, ";\n    --apple-pay-button-border-radius: ").concat(i, ";\n    --apple-pay-button-padding: ").concat(o, ";\n    --apple-pay-button-box-sizing: border-box;\n    width: ").concat(r, ";\n  }\n"));
				...
				(function(e, t) {
					...
					m.classList.add("logo"), h.appendChild(m), e.appendChild(h);
				})(e, {
					styles: C(o.applePay),
					theme: o.theme
				}), c.applePay = !0, t(c);
...
function M(e) {
	var t, n, a, r, i = o({}, e);
	i.metadata = e.metadata || {}, i.metadata.referrer = (t = window.location, n = t.href, a = void 0 === n ? "" : n, r = t.ancestorOrigins, [a].concat(l(void 0 === r ? [] : r)).map(V).join(",")), i.metadata = JSON.stringify(i.metadata), i.mode = "popup", e.split && "string" != typeof e.split && (i.split = JSON.stringify(i.split));
	return void 0 !== i.card && ["false", !1].indexOf(i.card) > -1 && (i.channels = ["bank"], delete i.card), void 0 !== i.bank && ["false", !1].indexOf(i.bank) > -1 && (i.channels = ["card"], delete i.bank), [
		{
			to: "firstname",
			from: "firstName"
		},
		...
		i[e.from] && (i[e.to] = i[e.from], delete i[e.from]);
...
var U = window && window.navigator && (window.navigator.platform || window.navigator.userAgentData && window.navigator.userAgentData.platform);
var N = function() {
	var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = e.platform, n = e.userAgent, a = void 0 === n ? window && window.navigator && window.navigator.userAgent : n, r = t || U;
	return L.includes(r) || a.includes("Mac") && "ontouchend" in document;
};
var B = function(e, t, n) {
	var a = "".concat(f.paystackApiUrl, "transaction/update_log/").concat(e), r = { Authorization: "Bearer ".concat(t) };
	return fetch(a, {
		method: "POST",
		body: JSON.stringify({ payload: JSON.stringify(n) }),
		headers: r
	});
};
var R = function(e, t) {
	var n = "".concat(f.paystackApiUrl, "transaction/set_ip/").concat(e), a = { Authorization: "Bearer ".concat(t) };
	return fetch(n, {
		method: "POST",
		headers: a
	});
...
var D = {
	initializeLog: function(e) {
		var t = e || {}, n = t.attempts, a = t.authentication, r = t.errors, i = t.history;
		this.log = {
	...
	logAPIResponse: function(e, t) {
		switch (e.status) {
			case "success": return this.logApiSuccess(t);
	...
	logAttempt: function(e) {
		var t = "Attempted to pay";
		return e && (t += " with ".concat(e)), this.log.attempts += 1, this.log.history.push({
			type: "action",
			message: t,
			time: this.getTimeSpent()
		}), this.saveLog();
	...
	logApiError: function(e) {
		var t = "Error";
		return e && (t += ": ".concat(e)), this.log.errors += 1, this.log.history.push({
			type: "error",
			message: t,
			time: this.getTimeSpent()
		}), this.saveLog();
	...
	logApiSuccess: function(e) {
		var t = "Successfully paid";
		return e && (t += " with ".concat(e)), this.log.success = !0, this.log.history.push({
			type: "success",
			message: t,
			time: this.getTimeSpent()
		}), this.saveLog();
	...
	saveLog: function() {
		try {
			if (this.response) return B(this.id, this.response.merchant_key, this.log);
		} catch (e) {}
	},
	saveIpAddress: function() {
		try {
			if (this.response) return R(this.id, this.response.merchant_key);
		} catch (e) {}
	}
};
var F = ["language", "connect_account"];
var W = { requestInline: function() {
	var e = this, t = this.urlParameters, n = t.language, a = t.connect_account, r = c(t, F), i = o({ "Content-Type": "application/json" }, n && { "Accept-Language": n });
	return (this.accessCode ? fetch(new URL("transaction/verify_access_code/".concat(this.accessCode), f.paystackApiUrl).toString(), { headers: i }) : fetch(new URL("/checkout/request_inline", f.paystackApiUrl).toString(), {
		method: "POST",
		body: JSON.stringify(r),
		headers: o(o({}, i), a && { "x-connect-account": a })
	})).then(function(e) {
		return e.json();
	}).then(function(t) {
		if (!1 === t.status) throw new Error(t.message);
		return e.response = t.data, e.id = t.data.id, e.status = t.data.transaction_status, e.accessCode = t.data.access_code, e.log = null, Object.assign(e, D), e.initializeLog(t.data.log), e.saveIpAddress(), t.data;
	});
} };
var J = function() {
	return a(function e(n) {
		t(this, e), function(e) {
			function t(e, t) {
				this.message = e, this.issues = t || [];
			}
			if (!e || "object" !== p(e)) throw new t("Transaction parameters should be a non-empty object");
			var n = e;
			if ("accessCode" in n) return { accessCode: n.accessCode };
			Object.keys(n).forEach(function(e) {
				void 0 !== j.find(function(t) {
					return t.value === e;
				}) || delete n[e];
			});
			var a = Object.keys(n), r = [];
			if (j.filter(function(e) {
				return e.required;
			}).forEach(function(e) {
				var t = !n[e.value], a = e.or ? e.or.some(function(e) {
					return n[e];
				}) : null;
				t && !a && r.push({ message: "Required parameter missing: ".concat(e.value) });
			}), a.forEach(function(e) {
				var t = n[e], a = j.find(function(t) {
					return t.value === e;
				}), i = p(t);
				"object" === i && Array.isArray(t) && (i = "array"), a.types.indexOf(i) <= -1 && r.push({
				...
				t.override && delete n[t.override];
			}), r.length) throw new t("Invalid transaction parameters", r);
		}(n), this.parameters = n, this.urlParameters = M(n), this.id = null, this.status = null, this.accessCode = n.accessCode || null, this.authorizationUrl = null, this.errors = [], this.response = null, this.isActive = !0;
		var a = n.onError, r = n.onLoad, i = n.onSuccess, o = n.onCancel, c = n.callback, s = n.onClose, l = n.onBankTransferConfirmationPending;
		this.callbacks = {
			onError: a,
			onLoad: r,
			onSuccess: i,
		...
		},
		{
			key: "onLoad",
			value: function(e) {
				var t = e.id, n = e.customer, a = e.accessCode;
				Object.assign(this, {
					id: t,
					customer: n,
					accessCode: a
				}), this.authorizationUrl = "".concat(f.checkoutUrl).concat(a), this.callbacks.onLoad && this.callbacks.onLoad({
					id: t,
					customer: n,
					accessCode: a
				});
...
var K = console ? console.warn || console.log : function() {};
function Q(e, t, n) {
	K("\"".concat(e, "\" has been deprecated, please use \"").concat(t, "\". ").concat(n || ""));
}
var G;
var H = [
	"preload",
...
function Y(e, t) {
	...
	var n = e.filter(function(e) {
		var n, a, r, i, o = !e.status || "abandoned" === e.status, c = (n = e.parameters, a = t, r = Object.keys(n).sort().join("") === Object.keys(a).sort().join(""), i = Object.values(n).sort().join("") === Object.values(a).sort().join(""), r && i);
		return o && c;
	});
	return n.length ? n[n.length - 1] : null;
}
function Z(e) {
	var t = e.checkoutIframe, n = e.urlParameters;
	t && n && t.contentWindow.postMessage({
		type: "inline:url",
		path: "newTransaction",
		params: n
	}, "*");
}
var $ = "trackPaymentError";
var ee = "trackPaymentAttempt";
var te = "trackPaymentCompletion";
function ne(e) {
...
var ie = function() {
	function e(n) {
		var a, r;
		t(this, e), this.id = function() {
			for (var e = "", t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", n = 0; n < 5; n += 1) e += t.charAt(Math.floor(62 * Math.random()));
			return e;
		}(), this.transactions = [], this.isOpen = !1, this.isLoaded = !1, this.isDeprecatedApi = n && n.isDeprecatedApi, n && n.isEmbed ? this.isEmbed = !0 : n && n.isPaymentRequest && (n.container && I(n.container) || ne("A container is required to mount the payment request button"), this.paymentRequestContainer = I(n.container), this.paymentRequestTransaction = null), this.backgroundIframe = function(e) {
			var t = T("inline-background-".concat(e));
			t.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  background: rgba(0, 0, 0, 0.75);    \n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  transition: opacity 0.3s;\n  -webkit-transition: opacity 0.3s;\n  visibility: hidden;\n  display: none;\n", t.style.colorScheme = "light", document.body.appendChild(t);
			var n = t.contentWindow.document;
			return n.open(), n.write("\n  <!DOCTYPE html>\n  <html lang=\"en\">\n\n  <head>\n    <meta charset=\"UTF-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    <meta http-equiv=\"X-UA-Compatible\" content=\"ie=edge\">\n    <title>Paystack Popup Loader</title>\n    <style>\n      .app-loader {\n        margin: 200px 0;\n        text-align: center;\n        color: white;\n      }      \n      @keyframes app-loader__spinner {\n        0% {\n          opacity: 1;\n        }\n        100% {\n          opacity: 0;\n        }\n      }\n      @-webkit-keyframes app-loader__spinner {\n        0% {\n          opacity: 1;\n        }\n        100% {\n          opacity: 0;\n        }\n      }\n      .app-loader__spinner {\n        position: relative;\n        display: inline-block;\n      }\n      .app-loader__spinner div {\n        left: 95px;\n        top: 35px;\n        position: absolute;\n        -webkit-animation: app-loader__spinner linear 1s infinite;\n        animation: app-loader__spinner linear 1s infinite;\n        background: white;\n        width: 10px;\n        height: 30px;\n        border-radius: 40%;\n        -webkit-transform-origin: 5px 65px;\n        transform-origin: 5px 65px;\n      }\n      .app-loader__spinner div:nth-child(1) {\n        -webkit-transform: rotate(0deg);\n        transform: rotate(0deg);\n        -webkit-animation-delay: -0.916666666666667s;\n        animation-delay: -0.916666666666667s;\n      }\n      .app-loader__spinner div:nth-child(2) {\n        -webkit-transform: rotate(30deg);\n        transform: rotate(30deg);\n        -webkit-animation-delay: -0.833333333333333s;\n        animation-delay: -0.833333333333333s;\n      }\n      .app-loader__spinner div:nth-child(3) {\n        -webkit-transform: rotate(60deg);\n        transform: rotate(60deg);\n        -webkit-animation-delay: -0.75s;\n        animation-delay: -0.75s;\n      }\n      .app-loader__spinner div:nth-child(4) {\n        -webkit-transform: rotate(90deg);\n        transform: rotate(90deg);\n        -webkit-animation-delay: -0.666666666666667s;\n        animation-delay: -0.666666666666667s;\n      }\n      .app-loader__spinner div:nth-child(5) {\n        -webkit-transform: rotate(120deg);\n        transform: rotate(120deg);\n        -webkit-animation-delay: -0.583333333333333s;\n        animation-delay: -0.583333333333333s;\n      }\n      .app-loader__spinner div:nth-child(6) {\n        -webkit-transform: rotate(150deg);\n        transform: rotate(150deg);\n        -webkit-animation-delay: -0.5s;\n        animation-delay: -0.5s;\n      }\n      .app-loader__spinner div:nth-child(7) {\n        -webkit-transform: rotate(180deg);\n        transform: rotate(180deg);\n        -webkit-animation-delay: -0.416666666666667s;\n        animation-delay: -0.416666666666667s;\n      }\n      .app-loader__spinner div:nth-child(8) {\n        -webkit-transform: rotate(210deg);\n        transform: rotate(210deg);\n        -webkit-animation-delay: -0.333333333333333s;\n        animation-delay: -0.333333333333333s;\n      }\n      .app-loader__spinner div:nth-child(9) {\n        -webkit-transform: rotate(240deg);\n        transform: rotate(240deg);\n        -webkit-animation-delay: -0.25s;\n        animation-delay: -0.25s;\n      }\n      .app-loader__spinner div:nth-child(10) {\n        -webkit-transform: rotate(270deg);\n        transform: rotate(270deg);\n        -webkit-animation-delay: -0.166666666666667s;\n        animation-delay: -0.166666666666667s;\n      }\n      .app-loader__spinner div:nth-child(11) {\n        -webkit-transform: rotate(300deg);\n        transform: rotate(300deg);\n        -webkit-animation-delay: -0.083333333333333s;\n        animation-delay: -0.083333333333333s;\n      }\n      .app-loader__spinner div:nth-child(12) {\n        -webkit-transform: rotate(330deg);\n        transform: rotate(330deg);\n        -webkit-animation-delay: 0s;\n        animation-delay: 0s;\n      }\n      .app-loader__spinner {\n        width: 40px;\n        height: 40px;\n        -webkit-transform: translate(-20px, -20px) scale(0.2) translate(20px, 20px);\n        transform: translate(-20px, -20px) scale(0.2) translate(20px, 20px);\n      }\n    </style>\n  </head>\n\n  <body>\n    <div id=\"app-loader\" class=\"app-loader\">\n      <div id=\"spinner\" class=\"app-loader__spinner\">\n        <div></div><div></div><div></div><div></div><div></div><div></div><div>\n        </div><div></div><div></div><div></div><div></div><div></div>\n      </div>\n    </div>\n  </body>\n\n  </html>\n"), n.close(), t;
		}(this.id), this.checkoutIframe = (a = this.id, (r = T("inline-checkout-".concat(a))).src = "".concat(f.checkoutUrl, "popup?precheckout=true"), r.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  visibility: hidden;\n  display: none;\n  height: 100%;\n", r.style.colorScheme = "light", r.setAttribute("allowpaymentrequest", "true"), r.setAttribute("allow", "payment; clipboard-read; clipboard-write"), document.body.appendChild(r), r), this.registerListeners();
	}
	return a(e, [
		{
			...
			value: function() {
				...
				window.addEventListener("message", function(t) {
					var n = "".concat(t.origin, "/") === f.checkoutUrl, a = e.checkoutIframe && e.checkoutIframe.contentWindow === t.source, r = e.isEmbed;
					n || a ? e.respondToEvent(t) : r && e.respondToEmbedEvents(t);
				});
			}
		},
		{
		...
		},
		{
			key: "checkout",
			value: function(e) {
				this.activeTransaction() && this.activeTransaction().cancel(), G = this;
				var t = Y(this.transactions, e) || new J(e);
				return new Promise(function(e, n) {
					t.requestInline().then(function(n) {
						G.newTransaction({
							inlineTransaction: t,
							transactionData: n
						}), e(t);
		...
		},
		{
			key: "newTransaction",
			value: function(e) {
				var t = e.preload, n = e.inlineTransaction, a = e.transactionData, r = c(e, H), i = this.paymentRequestContainer && _(this.paymentRequestContainer);
				if (this.activeTransaction() && !i && this.activeTransaction().cancel(), n && a) return this.transactions.push(n), this.isDeprecatedApi || this.open({
					accessCode: a.access_code,
					language: n.urlParameters.language
				}, t), n;
				var o = Y(this.transactions, n ? n.parameters : r);
				if (o) return o.isActive = !0, this.isDeprecatedApi || this.open({
					accessCode: o.accessCode,
					language: o.urlParameters.language
				}, t), o;
				var s = n || new J(r), l = s.accessCode ? {
					accessCode: s.accessCode,
					language: s.urlParameters.language
				} : s.urlParameters;
				return this.transactions.push(s), this.isDeprecatedApi || this.open(l, t), s;
			}
		},
		{
			...
			value: function(e) {
				var t = this;
				this.newTransaction(o(o({}, e), {}, { preload: !0 }));
				return function() {
		...
		},
		{
			key: "paymentRequest",
			value: function(e) {
				var t = e.container, n = e.styles, a = e.onElementsMount, r = c(e, X);
				return G = this, new Promise(function(i, o) {
					var c = document.querySelector("#".concat(e.loadPaystackCheckoutButton));
					if (q()) {
						G.activeTransaction() && G.activeTransaction().cancel(), t && I(t) || ne("A container is required to mount the payment request button"), G.paymentRequestContainer = I(t);
						var s = Y(G.transactions, r), l = s || new J(r);
						l.requestInline().then(function(e) {
							O(G.paymentRequestContainer, {
								channels: e.channels,
								styles: n
								...
								if (s ? l.isActive = !0 : G.transactions.push(l), G.registerPaymentRequestEventListeners(), c) c.onclick = G.preloadTransaction({
									inlineTransaction: l,
									transactionData: e
								});
								i(l);
						...
						if (e && e.loadPaystackCheckoutButton) if (c) c.onclick = G.preloadTransaction(r);
						else K("This device does not support any payment request wallet options. Please consult our documentation at https://developers.paystack.co/docs/paystack-inline to see how to load alternative payment options using 'loadPaystackCheckoutButton'");
						a && a(null);
						i(G.activeTransaction());
					}
				});
			}
		},
		{
			...
			value: function() {
				var e = this;
				_(this.paymentRequestContainer).onclick = function() {
		...
		},
		{
			...
			value: function() {
				...
				e && E(e.response.channels) ? this.registerApplePayEventListener() : z(this.paymentRequestContainer);
			}
		},
		{
			key: "startApplePay",
			value: function() {
				var e, t, n, a, r, i = this, c = "apple pay", s = this.activeTransaction();
				if (s) {
					var l = {
						channel: "apple_pay",
						paymentMethod: c,
					...
					try {
						s.logAttempt(c), this.sendAnalyticsEventToCheckout(ee, l);
						var p = (e = {
						...
						}, t = e.currency, n = e.amount, a = e.merchantName, r = e.interval, o({
							countryCode: "NG",
							currencyCode: t,
						...
						}, "string" == typeof r && "" !== r.trim() && { lineItems: [{
							label: A(r),
							amount: String(P(n))
						}] })), d = new window.ApplePaySession(f.applePayVersion, p);
						d.onvalidatemerchant = function(e) {
							(function(e) {
								var t = e.transactionId, n = e.validationURL, a = e.merchantName, r = e.domainName, i = void 0 === r ? window && window.location && window.location.hostname : r, c = "".concat(f.paymentBaseUrl).concat(f.applePayValidateSessionPath), s = x({
									transaction: t,
									sessionUrl: n,
									displayName: a,
									domainName: i
								});
								return fetch(c, o(o({}, S), {}, { body: s })).then(function(e) {
									return e.json();
								});
							})({
							...
							var t = e.payment;
							(function(e) {
								var t = e.transactionId, n = e.payment, a = "".concat(f.paymentBaseUrl).concat(f.applePayChargePath), r = x({
									transaction: t,
									paymentObject: JSON.stringify(n)
								});
								return fetch(a, o(o({}, S), {}, { body: r })).then(function(e) {
									return e.json();
								});
							})({
								transactionId: s.id,
								...
								s.logAPIResponse(e, c), "success" === e.status ? (d.completePayment(d.STATUS_SUCCESS), s.onSuccess(e), i.sendAnalyticsEventToCheckout(te, u)) : (d.completePayment(d.STATUS_FAILURE), s.onSetupError(e), i.sendAnalyticsEventToCheckout($, {
									channel: "apple_pay",
									message: e && e.message || "Transaction attempt failed"
								}));
							}).catch(function(e) {
								d.completePayment(d.STATUS_FAILURE), s.onSetupError(e), i.sendAnalyticsEventToCheckout($, {
									channel: "apple_pay",
				...
				} else ne("Could not initiate apple pay transaction");
			}
		},
		{
			key: "resumeTransaction",
			value: function(e) {
				var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = t.onSuccess, a = t.onCancel, r = t.onLoad, i = t.onError;
		...
		},
		{
			...
			value: function(e) {
				var t = this.transactions.find(function(t) {
					return t.id === e;
				}) || this.activeTransaction();
				t && (t.cancel(), this.close());
			}
		},
		{
			key: "respondToEvent",
			value: function(e) {
				if (e) {
					var t, n, a = this.activeTransaction();
					try {
						var r = e.data || e.message, i = r.event, o = r.data;
						if (i) switch (i) {
							...
							case "loaded:transaction":
								t = this.backgroundIframe, (n = t.contentWindow.document) && (n.getElementById("app-loader").style.display = "none"), a.onLoad(o);
								break;
							case "error":
								"setup" === o.type ? a.onSetupError(o) : a.logError(o);
								break;
							case "cancel":
							case "close":
								this.close();
								var u = o && o.status;
								u && a.setStatus(u), this.paymentRequestContainer && _(this.paymentRequestContainer) || (a.isActive = !1), a.onCancel();
								break;
							case "transfer:pending":
								...
								break;
							case "success": this.close(), a.onSuccess(o);
						}
					} catch (e) {}
				}
			}
		},
		{
			...
			value: function(e) {
				var t, n, a = this.activeTransaction(), r = e.data || e.message;
				if (r && ("string" == typeof r || r instanceof String)) {
					var i = {
						action: n = (t = r) && "string" == typeof t ? t.split(" ")[0] : null,
						data: n ? t.split(" ").slice(2).join(" ") : null
					};
					if (i && "PaystackClose" === i.action) i.data && a.onSuccess(r);
		...
		},
		{
			...
			value: function() {
				...
				if (!this.isOpen) (e = {
					...
					e || n("No dom element provided");
					var a = e.checkoutIframe, r = e.backgroundIframe;
					a && r || n("No dom element provided"), a.style.display = "", a.style.visibility = "visible", r.style.display = "", r.style.visibility = "visible", t();
				})).then(function() {
					t.checkoutIframe.contentWindow.postMessage("render", "*");
				}), this.isOpen = !0;
			}
		},
		{
			...
			value: function() {
				...
				if (this.isOpen) {
					...
					(t = {
						...
						t || n("No dom element provided");
						var a = t.checkoutIframe, r = t.backgroundIframe;
						a && r || n("No dom element provided"), r.style.opacity = 0, a.style.display = "none", a.style.visibility = "hidden", setTimeout(function() {
							r.style.display = "none", r.style.visibility = "hidden", r.style.opacity = 1, e();
						}, 300);
					})).then(function() {
		...
		value: function(t) {
			...
			G || (G = new e({
				isDeprecatedApi: !0,
				isEmbed: n
			})), Q("PaystackPop.setup()", "new PaystackPop()", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline");
			var a = G.newTransaction(t, "deprecated"), r = a.urlParameters;
			if (n) {
				var i = "".concat(f.siteUrl, "/assets/payment/production/inline.html?").concat(g(r)), o = function(e, t) {
					var n = T("embed-checkout-".concat(e));
					return n.style.cssText = "\n  background: transparent;\n  background: rgba(0,0,0,0);\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  nmargin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  visibility: hidden;\n  display: none;\n", n.src = t, n.id = e, n.name = e, n.setAttribute("allowpaymentrequest", "true"), n.setAttribute("allow", "payment; clipboard-read; clipboard-write"), n;
				}(G.id, i);
				(function(e, t) {
					var n = document.getElementById(e);
					n.innerHTML = "", n.removeAttribute("style"), n.className = "paystack-embed-container", n.style.position = "relative", n.style.width = "100%", n.appendChild(t);
				})(t.container, o), o.onload = function() {
					var e;
					o.contentWindow.postMessage("PaystackOpen ".concat(G.id), "*"), e = o, new Promise(function(t, n) {
						e || n("No dom element provided"), e.style.display = "", e.style.visibility = "visible", t();
					});
				};
			} else a.openIframe = function() {
				Q("openIframe", "open", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"), G.open(r);
			};
			return a;
		}
	}]);
}();
if (ae = k().length > 0, re = b() && "FORM" === b().parentElement.tagName, ae && re) {
	var oe, ce = function() {
		var e = {}, t = b();
		return k().forEach(function(n) {
			var a = t.getAttribute(n), r = n.split("data-")[1].replace(/-([a-z])/g, function(e) {
			...
			var t = o({}, e);
			t.buttonText = e.buttonText || "Pay", t.buttonVariant = "normal", t.buttonWordmarkVariant = "normal";
			var n = ["normal", "light"];
			return e.buttonVariant && n.indexOf(e.buttonVariant) > -1 && (t.buttonVariant = e.buttonVariant), e.buttonWordmarkVariant && n.indexOf(e.buttonWordmarkVariant) > -1 && (t.buttonWordmarkVariant = e.buttonWordmarkVariant), t;
		}(e);
	}(), se = b().parentElement;
	G || (G = new ie()), function(e) {
		var t;
		if (e.id) (t = document.getElementById(e.id)).setAttribute("data-inline-id", e.id);
		else {
			var n = document.createElement("div");
			n.id = "inline-button-".concat(e.inlineId), n.innerHTML = function(e) {
				var t, n;
				return "\n    <style>\n      #inline-button-".concat(e.inlineId, " {\n        position: relative;\n        text-align: center;\n        display: inline-block;\n      }\n      #inline-button-").concat(e.inlineId, "__trigger {\n        ").concat((t = e.variant || "normal", n = {
				...
				}[e.wordmarkVariant || "normal"], "\n    </div>\n  ");
			}(e), e.parent.parentNode.insertBefore(n, e.parent.nextSibling), t = s(n.getElementsByTagName("button"), 1)[0];
		}
		return t;
	}({
		inlineId: G.id,
		amount: ce.amount / 100,
		currency: ce.currency,
		id: ce.buttonId,
		text: ce.buttonText,
		variant: ce.buttonVariant,
		wordmarkVariant: ce.buttonWordmarkVariant,
		parent: b()
	}).addEventListener("click", function(e) {
		e.preventDefault(), oe ? G.resumeTransaction(oe.accessCode) : oe = G.newTransaction(o(o({}, ce), {}, { onSuccess: function(e) {
			var t = {
				type: "hidden",
				name: "reference",
				value: e.reference,
				parent: se
			}, n = t.type, a = t.value, r = t.name, i = t.parent, o;
			(o = document.createElement("input")).type = n, o.value = a, o.name = r, i.appendChild(o), se.submit();
		} }));
	});
}
//#endregion
